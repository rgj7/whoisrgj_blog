...
export default function BioWidget() {
  ...
  return (
    <aside className="bg-stone-100 dark:bg-navy-950 rounded-xl p-4 w-60 shrink-0 self-start border border-navy-800">
      ...
      {profile.bio && (
        <p className="text-sm text-stone-800 dark:text-navy-100 mt-3">{profile.bio}</p>
      )}
    </aside>
  )
}
